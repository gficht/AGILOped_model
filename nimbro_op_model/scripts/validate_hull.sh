...
direc=../igus_op_new_validated/

for i in hip_yaw_link.STL left_ankle_link.STL left_hip_link.STL left_lower_arm_link.STL left_shoulder_link.STL left_thigh_link.STL left_upper_arm_link.STL right_ankle_link.STL right_foot_link.STL right_hip_link.STL right_lower_arm_link.STL right_shoulder_link.STL right_thigh_link.STL right_upper_arm_link.STL shank_front_link.STL thigh_front_link.STL trunk_link.STL right_shank_link.STL left_shank_link.STL left_foot_link.STL head_link.STL neck_link.STL; do
    echo "Validating $i..."
	meshlabserver -i "$i" -o "$direc$i" -s validate_hull.mlx -om vn
done
